yahtzee: exemple.o libisentlib.a
	gcc -Wall exemple.o -o yahtzee libisentlib.a -lm -lglut -lGL -lX11
...
exemple.o: exemple.c GfxLib.h BmpLib.h ESLib.h imageSF.h
...
libisentlib.a: BmpLib.o ErreurLib.o ESLib.o GfxLib.o OutilsLib.o SocketLib.o ThreadLib.o TortueLib.o VectorLib.o WavLib.o imageSF.o
	ar r libisentlib.a BmpLib.o ErreurLib.o ESLib.o GfxLib.o OutilsLib.o SocketLib.o ThreadLib.o TortueLib.o VectorLib.o WavLib.o imageSF.o
